...
public class OJH_CreateRocket : MonoBehaviourPun
{
    ...
    void Update()
    {
        ...
        if (currTime > 20)
        {
            ...
            PhotonNetwork.Instantiate("Rocket", new Vector3(newX, gameObject.transform.position.y, newZ), Quaternion.Euler(-90, 0, 0));
            ...
            PhotonNetwork.Instantiate("Rocket", new Vector3(newX2, gameObject.transform.position.y, newZ2), Quaternion.Euler(-90, 0, 0));
            // 포톤으로 연료 생성
            currTime = 0;
        }
    }
